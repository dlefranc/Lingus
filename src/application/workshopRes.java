...
public class workshopRes extends windowWorkshop{
	...
	public void showStars(Integer score) throws IOException{
		if(score < 1) {
			...
			image4 = new Image(new File("src/resources/images/Stars/BlackStar.png").toURL().toString());
			image5 = new Image(new File("src/resources/images/Stars/BlackStar.png").toURL().toString());
			...
			image2 = new Image(new File("src/resources/images/Stars/GoldStar.png").toURL().toString());
			image3 = new Image(new File("src/resources/images/Stars/GoldStar.png").toURL().toString());
			image4 = new Image(new File("src/resources/images/Stars/GoldStar.png").toURL().toString());
			image5 = new Image(new File("src/resources/images/Stars/BlackStar.png").toURL().toString());
			star1.setImage(image1);
			star2.setImage(image2);
			star3.setImage(image3);
			...
			image3 = new Image(new File("src/resources/images/Stars/GoldStar.png").toURL().toString());
			image4 = new Image(new File("src/resources/images/Stars/GoldStar.png").toURL().toString());
			image5 = new Image(new File("src/resources/images/Stars/GoldStar.png").toURL().toString());
			star1.setImage(image1);
			star2.setImage(image2);
			star3.setImage(image3);
			star4.setImage(image4);
